...
logging.config.fileConfig('LoggingConfiguration2.ini')
...
class Sendmail:
    ...
    def __init__(self):
        ...
        self.turbomail_config = {
            'mail.on': True,
            'mail.transport': 'smtp',
            'mail.smtp.server': 'mailrelay.mail.com',
            #'mail.smtp.username':'majj@mail.com',
...
class StateCache:
    ...
    def sendMail(self):
        ...
        <body>
          <h1>你好!</h1>
          <a href="http://ccc.com/testinfo/cells/1">Real Time State</a>
          Please Check <b>%s</b>.
        </body>
        </html>   
        """%(self.device )
